...
Win::Win(Widget* parent, const char* n, void (*reframef)(Widget* w)) : Widget()
{
	...
	title_text = Text(this, "title", RichText(""), MAINFONT16, NULL, true, 1, 1, 1, 1.0f);
...
void Win::reframe()
{
	...
	for(i=m_subwidg.begin(); i!=m_subwidg.end(); i++)
		(*i)->reframe();
