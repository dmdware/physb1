 ...
 */
int32_t
utf8_to_wchar(const char *in, int32_t insize, unsigned int *out, int32_t outsize,
    int32_t flags)
{
	unsigned char *p, *lim;
 ...
 */
int32_t
wchar_to_utf8(const unsigned int *in, int32_t insize, char *out, int32_t outsize,
    int32_t flags)
{
	uint32_t *w, *wlim, ch;
