...
void InitGLSL()
{
	...
	//if(!strstr(szGLExtensions, "GL_ARB_gpu_shader_fp64") &&
	//	!strstr(szGLExtensions, "ARB_gpu_shader_fp64"))
	{
	//	ErrMess("Error", "GL_ARB_gpu_shader_fp64 not supported");
	}
...
void LoadShader(int32_t shader, const char* strVertex, const char* strFragment, bool hastexcoords, bool hasnormals)
{
    ...
    char vfull[PENCIL_MAX_PATH+1];
    char ffull[PENCIL_MAX_PATH+1];
